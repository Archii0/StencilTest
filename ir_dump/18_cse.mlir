module attributes {gpu.container_module} {
  llvm.func @laplace2d(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: !llvm.ptr, %arg8: !llvm.ptr, %arg9: i64, %arg10: i64, %arg11: i64, %arg12: i64, %arg13: i64) {
    ...
    %27 = builtin.unrealized_conversion_cast %4 : i64 to index
    gpu.launch_func  @laplace2d_kernel::@laplace2d_kernel blocks in (%27, %27, %17) threads in (%17, %17, %17)  args(%17 : index, %18 : index, %16 : index, %15 : memref<66x66xf64>, %3 : f64, %26 : memref<64x64xf64, strided<[66, 1], offset: 67>>)
    llvm.return
  }
  gpu.module @laplace2d_kernel [#nvvm.target<chip = "sm_90,triple=nvptx64-nvidia-cuda">] {
    llvm.func @laplace2d_kernel(%arg0: i64, %arg1: i64, %arg2: i64, %arg3: !llvm.ptr, %arg4: !llvm.ptr, %arg5: i64, %arg6: i64, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: f64, %arg11: !llvm.ptr, %arg12: !llvm.ptr, %arg13: i64, %arg14: i64, %arg15: i64, %arg16: i64, %arg17: i64) attributes {gpu.kernel, gpu.known_block_size = array<i32: 1, 1, 1>, nvvm.kernel, nvvm.maxntid = array<i32: 1, 1, 1>} {
      ...
      %25 = llvm.add %20, %24 overflow<nsw, nuw> : i64
      %26 = llvm.getelementptr inbounds|nuw %arg4[%25] : (!llvm.ptr, i64) -> !llvm.ptr, f64
      %27 = llvm.load %26 : !llvm.ptr -> f64
      %28 = llvm.add %20, %8 overflow<nsw, nuw> : i64
      %29 = llvm.getelementptr inbounds|nuw %arg4[%28] : (!llvm.ptr, i64) -> !llvm.ptr, f64
      %30 = llvm.load %29 : !llvm.ptr -> f64
      %31 = llvm.fadd %13, %18 : f64
      %32 = llvm.fadd %23, %27 : f64
      %33 = llvm.fadd %31, %32 : f64
      %34 = llvm.fmul %30, %arg10 : f64
      %35 = llvm.fadd %34, %33 : f64
      %36 = llvm.getelementptr %arg12[67] : (!llvm.ptr) -> !llvm.ptr, f64
      %37 = llvm.getelementptr inbounds|nuw %36[%28] : (!llvm.ptr, i64) -> !llvm.ptr, f64
