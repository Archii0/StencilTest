module {
  llvm.func @laplace2d(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: !llvm.ptr, %arg8: !llvm.ptr, %arg9: i64, %arg10: i64, %arg11: i64, %arg12: i64, %arg13: i64) {
    ...
    %subview = memref.subview %14[1, 1] [64, 64] [1, 1] : memref<66x66xf64> to memref<64x64xf64, strided<[66, 1], offset: 67>>
    %15 = builtin.unrealized_conversion_cast %subview : memref<64x64xf64, strided<[66, 1], offset: 67>> to !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
    omp.parallel {
      omp.wsloop {
